...
const navigation = {
  shop: [
    ...
    { name: "Proteínas", href: "/produtos?categoria=proteinas" },
    { name: "Creatina", href: "/produtos?categoria=creatina" },
    { name: "Pré-Treino", href: "/produtos?categoria=pre-treino" },
  ],
  about: [
    { name: "Sobre a CB Suplementos", href: "/sobre" },
 ...
 * Footer — Mobile-first
 *
 * Sem endereço físico (loja 100% online).
 *
      ...
      <div className="container-padded py-10 sm:py-14 lg:py-20">
        <div className="grid grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-12">
          ...
          <div className="col-span-2 lg:col-span-1">
            <Logo
              variant="horizontal"
              className="h-16 sm:h-20 w-auto mb-4 -ml-2"
            />
            <p className="text-[10px] sm:text-xs uppercase tracking-[0.3em] text-gold-light/80 mb-4 sm:mb-5">
              Supere seus limites
            </p>
            <p className="text-xs sm:text-sm leading-relaxed text-white/60 mb-5">
              Produtos 100% originais, entrega para todo Brasil e atendimento
              direto com quem entende.
            </p>
          ...
          {/* Loja */}
          <div>
            <h4 className="font-display text-xl sm:text-2xl text-gold mb-3 sm:mb-5 tracking-wider">Loja</h4>
          ...
          <div>
            <h4 className="font-display text-xl sm:text-2xl text-gold mb-3 sm:mb-5 tracking-wider">Institucional</h4>
            ...
            <div className="pt-5 border-t border-gold/10">
              <p className="text-[10px] uppercase tracking-widest text-gold-light/70 mb-2">
                Atendimento
              </p>
              <a
                href="https://wa.me/559199266197"
                className="block text-sm text-white/80 hover:text-gold transition-colors mb-1"
              >
                (91) 9926-6197
              </a>
              <a
                href="mailto:contato@cbsuplementos.com.br"
                className="block text-sm text-white/80 hover:text-gold transition-colors break-all"
              >
      ...
      <div className="border-t border-gold/10">
        <div className="container-padded py-4 sm:py-6 flex flex-col sm:flex-row items-center justify-between gap-2">
          <p className="text-[10px] sm:text-xs text-white/50">
            © {currentYear} CB Suplementos. Todos os direitos reservados.
          </p>
          <p className="text-[10px] sm:text-xs text-white/40 tracking-wider">
            Loja 100% online — Entregamos para todo Brasil
          </p>
        </div>
      </div>
    </footer>
